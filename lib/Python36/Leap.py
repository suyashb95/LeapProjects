...
class Device(Interface):
    ...
    if _newclass:serial_number = _swig_property(LeapPython.Device_serial_number_get)
    __swig_getmethods__["position"] = LeapPython.Device_position_get
    if _newclass:position = _swig_property(LeapPython.Device_position_get)
    __swig_getmethods__["orientation"] = LeapPython.Device_orientation_get
    if _newclass:orientation = _swig_property(LeapPython.Device_orientation_get)
...
class Image(Interface):
    ...
    if _newclass:sequence_id = _swig_property(LeapPython.Image_sequence_id_get)
    ...
    if _newclass:bytes_per_pixel = _swig_property(LeapPython.Image_bytes_per_pixel_get)
    __swig_getmethods__["format"] = LeapPython.Image_format_get
    if _newclass:format = _swig_property(LeapPython.Image_format_get)
...
class Controller(Interface):
    ...
    if _newclass:images = _swig_property(LeapPython.Controller_images_get)
...
class Listener(_object):
    ...
    def on_images(self, *args): return LeapPython.Listener_on_images(self, *args)
    def __disown__(self):
        self.this.disown()
